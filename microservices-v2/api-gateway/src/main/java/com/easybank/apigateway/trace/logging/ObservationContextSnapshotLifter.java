package com.easybank.apigateway.trace.logging;
...
public class ObservationContextSnapshotLifter<T> implements CoreSubscriber<T> {
    ...
    public ObservationContextSnapshotLifter(CoreSubscriber<? super T> delegate) {
        this.delegate = delegate;
        this.observationThreadLocalAccessor = findObservationThreadLocalAccessor();
    }
